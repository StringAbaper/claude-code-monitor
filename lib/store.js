...
function getFullState() {
  return {
    ...
    settings: { remoteApprovalEnabled, autoApproveEnabled, stoppedCleanupMinutes, showTokenChart, autoArchiveStopped, autoUpdateEnabled, updateChannel },
...
function getConfig() {
  return { remoteApprovalEnabled, autoApproveEnabled, stoppedCleanupMinutes, showTokenChart, autoArchiveStopped, autoUpdateEnabled, updateChannel };
}
