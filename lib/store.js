...
function loadConfig() {
  try {
    if (fs.existsSync(CONFIG_FILE)) {
      ...
      dashboardPassword = data.dashboardPassword || null;
    }
  } catch {}
...
function getDashboardPassword() { return dashboardPassword; }
function setDashboardPassword(pw) { dashboardPassword = pw; saveConfig(); }
